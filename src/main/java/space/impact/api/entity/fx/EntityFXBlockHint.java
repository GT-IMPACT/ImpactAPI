...
import space.impact.api.proxy.ClientProxy;
...
public class EntityFXBlockHint extends EntityFX {
	...
	public EntityFXBlockHint(World world, int x, int y, int z, IIcon[] icons) {
		...
		prevPosZ        = posZ;
		noClip          = true;
		particleMaxAge  = 2000/* + Main.RANDOM.nextInt(200)*/;
		this.icons      = icons;
	}
	...
	public void renderParticle(Tessellator tes, float subTickTime, float p_70539_3_, float p_70539_4_, float p_70539_5_, float p_70539_6_, float p_70539_7_) {
		...
		tes.setColorRGBA((int) (mRGBa[0] * .9F), (int) (mRGBa[1] * .95F), (int) (mRGBa[2] * 1F), 222);
		box(tes, X, Y, Z);
